        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6">
            <div className="bg-white border border-[#e2e8f0]/60 rounded-xl p-2 sm:p-4 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-1 sm:gap-3 hover:shadow-md transition-all">
                ...
                <div className="flex flex-col items-center sm:items-start w-full">
                    ...
                    <div className="text-xl sm:text-2xl font-bold text-[#102129] leading-none order-1 sm:order-2">{stats.total}</div>
                </div>
            </div>
            <div className="bg-white border border-[#e2e8f0]/60 rounded-xl p-2 sm:p-4 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-1 sm:gap-3 hover:shadow-md transition-all">
                ...
                <div className="flex flex-col items-center sm:items-start w-full">
                    ...
                    <div className="text-xl sm:text-2xl font-bold text-[#102129] leading-none order-1 sm:order-2">{stats.completed}</div>
                </div>
            </div>
            <div className="bg-white border border-[#e2e8f0]/60 rounded-xl p-2 sm:p-4 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-1 sm:gap-3 hover:shadow-md transition-all">
                ...
                <div className="flex flex-col items-center sm:items-start w-full">
                    ...
                    <div className="text-xl sm:text-2xl font-bold text-[#102129] leading-none order-1 sm:order-2">{stats.pending}</div>
                </div>
            </div>
        </div>
    );
